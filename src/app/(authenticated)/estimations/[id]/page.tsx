...
export default function EstimationDetailPage({
    ...
    async function fetchEvaluation() {
      try {
        ...
        toast({
          ...
          description:
            "Cette demande d'estimation n'existe pas ou a été supprimée.",
          variant: "destructive",
        });
      } finally {
        setIsLoading(false);
  ...
  const amenities = [
    {
      label: "Garage",
      value: evaluation.hasGarage,
      icon: <Car className="h-4 w-4" />,
    },
    {
      label: "Piscine",
      value: evaluation.hasPool,
      icon: <Waves className="h-4 w-4" />,
    },
    {
      label: "Jardin",
      value: evaluation.hasGarden,
      icon: <Trees className="h-4 w-4" />,
    },
    {
      label: "Balcon",
      value: evaluation.hasBalcony,
      icon: <Building className="h-4 w-4" />,
    },
    {
      label: "Terrasse",
      value: evaluation.hasTerrace,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Badge
            variant="outline"
            className={`${situationConfig[evaluation.situation]?.className} text-sm px-3 py-1`}
          >
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-semibold text-foreground">
                    {propertyTypeLabels[evaluation.propertyType] ||
          ...
          <Card className="shadow-card">
            <CardHeader>
              ...
              <CardDescription>
                Ajoutez vos notes sur cette demande
              </CardDescription>
            </CardHeader>
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-foreground">
                  {new Date(evaluation.updatedAt).toLocaleDateString("fr-FR")}
                </span>
              </div>
            </CardContent>
          </Card>
