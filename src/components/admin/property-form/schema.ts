...
export const propertyFormSchema = z.object({
  ...
  transactionType: z.enum(
    ["VENTE", "LOCATION", "VIAGER", "LOCATION_SAISONNIERE"],
    {
  ...
  honorairesPct: z.coerce
    .number()
    .min(0, "Le pourcentage d'honoraires doit être positif ou nul")
  ...
  bedrooms: z.coerce
    .number()
    .int()
    .min(0, "Le nombre de chambres doit être positif ou nul"),
  bathrooms: z.coerce
    .number()
    .int()
    .min(0, "Le nombre de salles de bain doit être positif ou nul"),
  showerRooms: z.coerce
    .number()
    .int()
    .min(0, "Le nombre de salles d'eau doit être positif ou nul")
    .optional()
    .nullable(),
  toilets: z.coerce
    .number()
    .int()
    .min(0, "Le nombre de WC doit être positif ou nul")
    .optional()
    .nullable(),
  ...
  dpeImageUrl: z
    ...
    .refine(
      ...
      "URL ou data URL invalide pour l'image DPE",
    )
    .optional()
    .nullable(),
  gesImageUrl: z
    ...
    .refine(
      (v) => !v || v.startsWith("data:") || /^https?:\/\//.test(v),
      "URL ou data URL invalide pour l'image GES",
    )
    .optional()
    .nullable(),
