...
export function GeneralInfoStep({
  ...
  useEffect(() => {
    if (honorairesType === "acquereur" && price && honorairesPct) {
      const calculatedHonoraires =
        (Number(price) * Number(honorairesPct)) / (100 + Number(honorairesPct));
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Appartement T3 avec balcon en centre-ville"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
                ...
                <div className="grid gap-3 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">
                      {Number(form.watch("price")).toLocaleString("fr-FR")} €
                    </span>
                  </div>
                  <div className="flex justify-between items-center gap-4">
                    <span className="text-muted-foreground">
                      Honoraires ({form.watch("honorairesPct")}%)
                    </span>
                        ...
                        onClick={() => {
                          const calculatedHonoraires =
                            (Number(form.watch("price")) *
                              Number(form.watch("honorairesPct"))) /
                            (100 + Number(form.watch("honorairesPct")));
                          const roundedHonoraires =
                            roundToNiceNumber(calculatedHonoraires);
                          form.setValue("honoraires", roundedHonoraires);
                        }}
